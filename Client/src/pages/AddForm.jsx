...
function AddForm() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://t4.ftcdn.net/jpg/07/28/83/53/240_F_728835351_HVSeQ7fAZewLKLM5hDysk1kOQFZAQIXP.jpg")',
      }}
    >
      <h1 className="text-3xl font-bold text-red-500 mb-4">Add Recipe</h1>
